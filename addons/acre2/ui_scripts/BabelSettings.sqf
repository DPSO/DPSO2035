...
//ret = (get3DENSelected "Object" select 0) set3DENAttribute ["DPSO_Channellist","1"];
//set3DENAttributes [[get3DENSelected "Object","DPSO_Channelset",[1,2,3]]];
...
fn_removeUnitFromLang = {
    ...
    _list = (_unit get3DENAttribute "DPSO_BabelLanguages") params ["_value"];
    if (_value isEqualType []) then {
        ...
        _unit set3DENAttribute ["DPSO_BabelLanguages",str _value];
    };
};
...
fn_removeGroupFromLang = {
    ...
    _list = (_group get3DENAttribute "DPSO_BabelLanguages") params ["_value"];
    if (_value isEqualType []) then {
        //Is Default do nothing
        ...
        _group set3DENAttribute ["DPSO_BabelLanguages",str _value];
    };
...
switch _mode do {
    case "onLoad": {
        ...
        BabelArray = ("DPSO_MissionAcre2Attributes" get3DENMissionAttribute "DPSO_AcreBabelSettings");
    ...
    case "refreshLangTree": {
        ...
        fn_langTreeProcessUnit = {
            ...
            if (!_doSpeak) then {
                private _unitChanList = (_unit get3DENAttribute "DPSO_BabelLanguages") select 0;
            ...
            if (_doSpeak) then {
                _ctrlTree tvSetPictureRight [_location, "z\dpso\addons\acre2\ui\bable_on.paa"];
                _returnCode = 0;
            } else {
                _ctrlTree tvSetPictureRight [_location, "z\dpso\addons\acre2\ui\bable_off.paa"];
            };
        ...
        fn_langTreeProcessGroup = {
            ...
            if (!_doSpeak) then {
                private _grpChanList = (_group get3DENAttribute "DPSO_BabelLanguages") select 0;
            ...
            if (_doSpeak) then {
                ...
                if (_hasSpeaker) then {
                    _ctrlTree tvSetPictureRight [_location, "z\dpso\addons\acre2\ui\bable_partial.paa"];
        ...
        with uiNamespace do {
            ...
            if (_entity isEqualType east or _entity isEqualType "") then {
                ...
                if (_entity isEqualType grpNull or _entity isEqualType objNull) then {
                    _list = (_entity get3DENAttribute "DPSO_BabelLanguages") params ["_value"];
                    if (_value isEqualType []) then {
                        _entity set3DENAttribute ["DPSO_BabelLanguages",str [_curSel]];
                    } else {
                        _value = call compile _value;
                        _value pushBackUnique _curSel;
                        _entity set3DENAttribute ["DPSO_BabelLanguages",str _value];
                    };
                };
            };
    ...
    case "save": {
        ...
        private _string = str _array;
        set3DENMissionAttributes [["DPSOMissionAcreAttributes","DPSO_AcreBabelSettings",_string]];
    };
};
