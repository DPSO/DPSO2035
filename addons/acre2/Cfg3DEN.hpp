...
{
    DPSO_acre2 = "z\dpso\addons\acre2\ui_scripts\"; //"
};
...
class Cfg3DEN
{
    class Mission
    {
        class DPSO_MissionAcre2Attributes // Custom section class, everything inside will be opened in one window (MySection)
        {
            ...
            {
                class DPSO_AcreGeneralSettings
                {
                    displayName = "DPSO: General ACRE2 settings"; // Category name visible in Edit Attributes window
                    collapsed = 0; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class Network_Enabled
                        {
                            property = "DPSO_AcreNetworkEnabled";
                            displayName = "Enable custom networks";
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['DPSO_NetworkEnabled',_value];";
                        ...
                        class Babel_Enabled
                        {
                            property = "DPSO_AcreBabelEnabled";
                            displayName = "Babel enabled:";
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['DPSO_BabelEnabled',_value];";
                        ...
                        class Action_Radios
                        {
                            property = "DPSO_AcreAddRadioActions";
                            displayName = "Action radios:";
                            control = "DPSO_AcreAddRadioActions";
                            //expression = "missionNamespace setVariable ['DPSO_AcreAddRadioActions',_value];";
                ...
                class DPSO_AcreBabelSettings
                {
                    displayName = "DPSO: Languages (Babel System)"; // Category name visible in Edit Attributes window
                    collapsed = 1; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class Languages
                        {
                            property = "DPSO_AcreBabelSettings";
                            control = "BabelSettings";
                            //expression = "missionNamespace setVariable ['DPSO_BabelArray',_value];";
                            tooltip = "";
                            defaultValue = "[]";
                            condition = "1";
                            wikiType = "[[String]]";
                ...
                class DPSO_AcreSettings
                {
                    displayName = "DPSO: Radios"; // Category name visible in Edit Attributes window
                    collapsed = 1; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class RadioChannels
                        {
                            property = "DPSO_AcreSettings";
                            control = "RadioChannels";
                            displayName = "";
                            tooltip = "";
                            //expression = "missionNamespace setVariable ['DPSO_RadioArray', _value];";
                            defaultValue = "[]";
                            condition = "1";
                            wikiType = "[[String]]";
                        };
    ...
    class Group
    {
        ...
        class AttributeCategories
        {
            ...
            class DPSOMarker
            {
                class Attributes
                {
                    class DPSO_BabelLanguages
                    {
                        displayName = "Babel languages"; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "DPSO_BabelLanguages"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'DPSO_BabelLanguages',_value] call dpso_common_fnc_initGroupVar;";// "_this setVariable ['DPSO_BabelLanguages',_value,true];";
                        wikiType = "[[String]]";
                        defaultValue = "[]";
                    };
                    class DPSO_Network
                    {
                        ...
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "DPSO_Network"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'DPSO_Network',_value] call dpso_common_fnc_initGroupVar;";// expression = "_this setVariable ['DPSO_Network',_value,true];";
                        wikiType = "[[Number]]";
                        defaultValue = -1;                        
                    };
                    class DPSO_Channellist
                    {
                        displayName = "Radio channel list"; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "DPSO_Channellist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'DPSO_Channellist',_value] call dpso_common_fnc_initGroupVar;";// expression = "_this setVariable ['DPSO_Channellist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                    class DPSO_ChannellistLeader
                    {
                        displayName = "Leader radio channel list"; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "DPSO_ChannellistLeader"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'DPSO_ChannellistLeader',_value] call dpso_common_fnc_initGroupVar;";// expression = "_this setVariable ['DPSO_ChannellistLeader',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                };
    ...
    class Object
    {
        ...
        class AttributeCategories
        {
            ...
            class DPSOMarker
            {
                displayName = "DPSO: ACRE Variable Place Holder"; // Category name visible in Edit Attributes window
                collapsed = 1; // When 1, the category is collapsed by default
                class Attributes
                {
                    class DPSO_Network
                    {
                        ...
                        property = "DPSO_Network"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['DPSO_Network',_value,true];";
                        wikiType = "[[Number]]";
                        defaultValue = -1;
                    ...
                    class DPSO_Channellist
                    {
                        ...
                        property = "DPSO_Channellist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['DPSO_Channellist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                        condition = "objectBrain"; // Condition for attribute to appear (see the table below)
                    };
                    class DPSO_BabelLanguages
                    {
                        ...
                        property = "DPSO_BabelLanguages"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['DPSO_BabelLanguages',_value,true];";
                        wikiType = "[[String]]";
                        defaultValue = "[]";
                        condition = "objectBrain"; // Condition for attribute to appear (see the table below)
                    };
    ...
    class Attributes
    {
        ...
        class DPSO_AcreAddRadioActions : Toolbox {
            scriptName = "AcreAddRadioActions";
            scriptPath = "DPSO_acre2";
            onLoad = "['onLoad',_this,'AcreAddRadioActions','DPSO_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'AcreAddRadioActions','DPSO_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
        ...
        class BabelSettings : Toolbox
        {
            ...
            scriptPath = "DPSO_acre2";
            onLoad = "['onLoad',_this,'BabelSettings','DPSO_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'BabelSettings','DPSO_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
        ...
        class RadioChannels : Toolbox
        {
            ...
            scriptPath = "DPSO_acre2";
            onLoad = "['onLoad',_this,'RadioChannels','DPSO_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'RadioChannels','DPSO_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
