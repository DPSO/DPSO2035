...
[
    ["ACE_ATNAA","dpso_medbags_Trauma","kat_IO_FAST","kat_IV_16","kat_TXA","kat_amiodarone","kat_atropine","kat_lidocaine","kat_naloxone","kat_nitroglycerin","kat_norepinephrine","kat_phenylephrine","ACE_epinephrine","ACE_morphine","ACE_adenosine","kat_aatKit","kat_Painkiller","kat_accuvac","ACE_adenosine","dpso_epinephrine","ACE_epinephrine","kat_X_AED","dpso_NDC","ACE_elasticBandage","ACE_packingBandage","kat_crossPanel","kat_bloodIV_O","kat_bloodIV_A","kat_bloodIV_AB","ACE_bloodIV","kat_bloodIV_B","ACE_bloodIV_250","kat_bloodIV_O_250","kat_bloodIV_A_250","kat_bloodIV_AB_250","kat_bloodIV_B_250","ACE_bloodIV_500","kat_bloodIV_O_500","kat_bloodIV_A_500","kat_bloodIV_AB_500","kat_bloodIV_B_500","ACE_bodyBag","dpso_medbags_FirstAid","dpso_medbags_DrugKit","dpso_fentanyl","KAT_Empty_bloodIV_250","KAT_Empty_bloodIV_500","FirstAidKit","kat_AED","kat_chestSeal","kat_larynx","dpso_ketamine","ACE_fieldDressing","dpso_medbags_MedicKit","Medikit","dpso_morphine","ACE_morphine","dpso_naloxone","dpso_triangleban","kat_guedel","dpso_Apap","ACE_personalAidKit","ACE_plasmaIV","ACE_plasmaIV_250","ACE_plasmaIV_500","kat_Pulseoximeter","ACE_quikclot","ACE_salineIV_250","ACE_salineIV","ACE_salineIV_500","ACE_splint","kat_stethoscope","vtx_stretcher_item","ACE_surgicalKit","dpso_tetra","ACE_tourniquet","Attachable_Helistretcher","dpso_VPN"],
    "Medical",
...
[
    ...
    "USP",
    "z\dpso\addons\equipment\data\usp_icon.paa"
] call ACEFUNC(arsenal,addRightPanelButton);
