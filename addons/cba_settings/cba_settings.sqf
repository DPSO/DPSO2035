...
CBRN_factionMask_dpso = "G_CBRN_M50";
...
// DPSO
dpso_common_weaponSafety = true;

// DPSO - adminmenu
dpso_adminmenu_endLogToRPT = false;
force dpso_adminmenu_printToChat = 1;

// DPSO - AI
force dpso_AI_AimingAccuracy = 0.1;
...
// DPSO - ai_disembark
force dpso_ai_disembark_enabled = true;
force dpso_ai_disembark_stayInImmobileChance = 0.2927;

// DPSO - back_to_game
dpso_back_to_game_enableAddon = true;
force dpso_back_to_game_removeBody = true;
force dpso_back_to_game_teleportToLeader = true;
force dpso_back_to_game_teleportToVehicle = true;

// DPSO - Bodybag
force dpso_bodybag_destroyChance = 20;

// DPSO - Channels
force dpso_Channels_CommandDuration = 0;
force dpso_Channels_CommandText = true;
force dpso_Channels_CommandVoice = false;
force dpso_Channels_DirectDuration = 0;
force dpso_Channels_DirectText = true;
force dpso_Channels_DirectVoice = false;
force dpso_Channels_GlobalDuration = 0;
force dpso_Channels_GlobalText = true;
force dpso_Channels_GlobalVoice = false;
force dpso_Channels_GroupDuration = 0;
force dpso_Channels_GroupText = true;
force dpso_Channels_GroupVoice = false;
force dpso_Channels_SideDuration = 0;
force dpso_Channels_SideText = true;
force dpso_Channels_SideVoice = false;
force dpso_Channels_VehicleDuration = 0;
force dpso_Channels_VehicleText = true;
force dpso_Channels_VehicleVoice = false;

// DPSO - Chat
force dpso_chat_healUsage = 3;
force dpso_chat_radioUsage = 3;
force dpso_chat_rpUsage = 3;
force dpso_chat_specUsage = 3;
force dpso_chat_tpUsage = 3;
force dpso_chat_whisperUsage = 3;

// DPSO - fatigue
dpso_fatigue_highJogCoef = 0;
dpso_fatigue_highJogCoefEnabled = false;

// DPSO - friendly_fire
force dpso_friendly_fire_loggingEnabled = true;

// DPSO - fries
force dpso_fries_autoAdd = true;

// DPSO - grass
force dpso_grass_enabled = true;

// DPSO - insurgents
force dpso_insurgents_enabled_CUP = false;
force dpso_insurgents_enabled_Vanilla = true;

// DPSO - Interaction
DPSO_CreatorActions_Channels = true;
DPSO_CreatorActions_EndMission = true;
DPSO_CreatorActions_Master = true;

// DPSO - Interactions
dpso_interactions_backpack_access_enemy = 0;
dpso_interactions_backpack_access_faction = 2;
dpso_interactions_backpack_access_friendly = 1;
dpso_interactions_backpack_access_hint = true;
dpso_interactions_gear_access_enabled = 1;
dpso_interactions_gear_access_hint = true;
dpso_interactions_global_sounds = true;
dpso_interactions_tapshoulder_ai = false;
dpso_interactions_tapshoulder_hint = true;

// DPSO - Main
force DPSO_Main_ArsenalSaveLoad = true;
force DPSO_Main_CueCards = true;
force DPSO_Main_Diary = true;
force DPSO_Main_DynamicGroups = true;
force DPSO_Main_DynamicSim = false;
force DPSO_Main_Earplugs = false;
force DPSO_Main_FatigueVanilla = true;
force DPSO_Main_FlipVehicle = true;
force DPSO_Main_LockCamVehicle = false;
force DPSO_Main_Logging = true;
force DPSO_Main_MapIcons = true;
force DPSO_Main_MaydayAccess = 2;
force DPSO_Main_PilotCheck = false;
force DPSO_Main_QSMagRepack = false;
force DPSO_Main_VehicleCrewList = true;
force DPSO_Main_ViewDistanceMaxDistance = 10000;
force DPSO_Main_ViewDistanceMaxObjectDistance = 10000;
force DPSO_Main_ViewDistanceNoGrass = false;

// DPSO - medical
force DPSO_medical_persistantRevive = true;
force DPSO_medical_persistantReviveTimer = 720;

// DPSO - pointing
force dpso_pointing_vehicleEnabled = true;

// DPSO - RATEL Marker
force dpso_ratelmarker_QuickReferenceMarkerMode = 2;

// DPSO - respawn
force dpso_respawn_enabled = true;
force dpso_respawn_time = 10;

// DPSO - safestart
dpso_safestart_startLocked = true;

// DPSO - Spectator
force dpso_spectator_allowAI = false;
force dpso_spectator_allowAIUnconscious = false;
force dpso_spectator_allowUnconscious = false;
force dpso_spectator_civilianSide = false;
force dpso_spectator_civilianSideUnconscious = false;
force dpso_spectator_freeCamera = false;
force dpso_spectator_freeCameraUnconscious = false;
force dpso_spectator_sides = 1;
force dpso_spectator_sidesUnconscious = 1;
force dpso_spectator_TPPCamera = false;
force dpso_spectator_TPPCameraUnconscious = false;
force dpso_spectator_unconsciousDelay = 30;

// DPSO - Suppress
force dpso_suppress_checkLOS = true;
force dpso_suppress_overlayFadeoutTime = 10;
force dpso_suppress_overlayOpacity = 0.96;
force dpso_suppress_overlayTexture = 0;
force dpso_suppress_projectileMaxDistance = 9;
force dpso_suppress_shooterMinDistance = 0;

// DPSO - tagging
force dpso_tagging_enabled = true;

// DPSO - towing
force dpso_towing_addToCars = true;
force dpso_towing_addToHeavyDutyVehicles = true;
...
force dpso_Zeus_Module_MedicalDummy = true;
dpso_Zeus_Module_SafeZone = true;
