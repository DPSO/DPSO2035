...
/////////////////////////////////////
    ...
    class CLASS(MX_DPSO): arifle_MX_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        ...
        baseWeapon = QCLASS(MX_DPSO);
    };
    class CLASS(MX_GL_DPSO): arifle_MX_GL_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
...
/////////////////////////////////////
    ...
    class CLASS(MXM_DPSO): arifle_MXM_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
...
/////////////////////////////////////
    ...
    class CLASS(MXC_DPSO): arifle_MXC_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
...
/////////////////////////////////////
    ...
    class CLASS(MX_SW_DPSO): arifle_MX_SW_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
...
/////////////////////////////////////////////
    class CLASS(MX_jesus): arifle_MX_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        displayName = CSTRING(MX_jesus);
        picture = QPATHTOF(UI\mx_blackcamo_ca.paa);
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_base_co-jesus.paa),
            QPATHTOF(data\mx\xmx_base_co-jesus.paa)
        };
        baseWeapon = QCLASS(MX_jesus);
    };
    class CLASS(MX_GL_jesus): arifle_MX_GL_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        displayName = CSTRING(MX_GL_jesus);
        picture = QPATHTOF(UI\mx_gl_blackcamo_ca.paa);
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_base_co-jesus.paa),
        ...
        baseWeapon = QCLASS(MX_GL_jesus);
    };

    class CLASS(MX_YonV): arifle_MX_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        displayName = CSTRING(MX_YonV);
        picture = QPATHTOF(UI\mx_blackcamo_ca.paa);
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_base_co-YonV.paa),
            QPATHTOF(data\mx\xmx_base_co-YonV.paa)
        };
        baseWeapon = QCLASS(MX_YonV);
    };
    class CLASS(MX_GL_YonV): arifle_MX_GL_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        displayName = CSTRING(MX_GL_YonV);
        picture = QPATHTOF(UI\mx_gl_blackcamo_ca.paa);
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_base_co-YonV.paa),
...
/////////////////////////////
    ...
    class CLASS(MXM_jesus): arifle_MXM_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        ...
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_long_co-jesus.paa),
            QPATHTOF(data\mx\xmx_long_co-jesus.paa)
        };
        baseWeapon = QCLASS(MXM_jesus);
    };

    class CLASS(MXM_YonV): arifle_MXM_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        ...
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_long_co-YonV.paa),
            QPATHTOF(data\mx\xmx_long_co-YonV.paa)
        };
        baseWeapon = QCLASS(MXM_YonV);
    };
    ...
    class CLASS(MXC_blackcamo): arifle_MXC_Black_F {
        ...
        baseWeapon = QCLASS(MXC_jesus);
    };
    class CLASS(MXC_jesus): arifle_MXC_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        ...
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_short_co-jesus.paa),
            QPATHTOF(data\mx\xmx_short_co-jesus.paa)
        };
        baseWeapon = QCLASS(MXC_jesus);
    };

    class CLASS(MXC_YonV): arifle_MXC_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        ...
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_short_co-YonV.paa),
            QPATHTOF(data\mx\xmx_short_co-YonV.paa)
        };
        baseWeapon = QCLASS(MXC_YonV);
    };
    ...
    class CLASS(MX_SW_blackcamo): arifle_MX_SW_Black_F {
     ...
     class CLASS(MX_SW_jesus): arifle_MX_SW_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        ...
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_lmg_co-jesus.paa),
            QPATHTOF(data\mx\xmx_lmg_co-jesus.paa)
        };
        baseWeapon = QCLASS(MX_SW_jesus);
    };

    class CLASS(MX_SW_YonV): arifle_MX_SW_Black_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        author = "YonV";
        ...
        hiddenSelections[] = {"camo1", "camo2"};
        hiddenSelectionsTextures[] = {
            QPATHTOF(data\mx\xmx_lmg_co-YonV.paa),
            QPATHTOF(data\mx\xmx_lmg_co-YonV.paa)
        };
        baseWeapon = QCLASS(MX_SW_YonV);
    };
