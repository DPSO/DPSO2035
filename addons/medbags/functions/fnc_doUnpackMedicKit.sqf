...
[_unit] spawn {
 ...
 {true},
    ...
    if (DPSO_MEDICAL_SUPPLIES_UNPACK_SUCCESS) exitWith {
        ...
        _unit removeItem "DPSO_medbags_MedicKit";
        ...
        [_unit, "kat_Painkiller", 01, _order, _overflow] call dpso_common_fnc_addItem;
        [_unit, "ACE_tourniquet", 04, _order, _overflow] call dpso_common_fnc_addItem;
        [_unit, "ACE_EarPlugs", 02, _order, _overflow] call dpso_common_fnc_addItem;
