 ...
 *	\z\dpso\addons\mainmenu\scripts\versionInfo.sqf
 *	by Ojemineh
 *	
 ...
 *	
 *	Example:
 *	[0] execVM "\z\dpso\addons\mainmenu\scripts\versionInfo.sqf";
 *	
 */
...
if (profileNamespace getVariable ["dpso_showNewsOnMainMenu", true]) then {
    ...
    (_display displayCtrl 90092) htmlLoad (localize "STR_DPSO_Addon_URL_Version");
