...
/*
Function: DPSO_Player_fnc_ConfigPlayer
...
Arguments:
    ...
    _Loadout - Name of Loadout to call. Changes player equipment to Loadout from DPSO. <STRING>

Examples:
    (begin example)
        [this] call DPSO_Player_fnc_ConfigPlayer;
        [this, "1 Section"] call DPSO_Player_fnc_ConfigPlayer;
        [this, "909 EAW", ["Pilot"]] call DPSO_Player_fnc_ConfigPlayer;
        [this, "Command", ["Pilot", "Mission Maker"]] call DPSO_Player_fnc_ConfigPlayer;
        [this, "909 EAW", ["Pilot"], "3CB Pilot"] call DPSO_Player_fnc_ConfigPlayer;
    (end)
