class DPSO_ModulePortableFOB_Camp: Module_F
{
	scope = 2;
...
class DPSO_ModulePortableFOB_Small: Module_F
{
	scope = 2;
...
class DPSO_ModulePortableFOB_Medium: Module_F
{
	scope = 2;
...
class DPSO_ModulePortableFOB_Large: Module_F
{
	scope = 2;
