...
_compArray = call (compile format ["call DPSO_fnc_%1", _type]);
...
_object setVariable ["DPSO_PortableFOB_Objects", _objects, true];
_object setVariable ["DPSO_PortableFOB_HiddenObjects", _hiddenObjects, true];
_object setVariable ["DPSO_PortableFOB_Deployed", true, true];
_object setVariable ["DPSO_PortableFOB_Pos", _pos, true];
_object setVariable ["DPSO_PortableFOB_RespawnPos", _respawnPos, true];
