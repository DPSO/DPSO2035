 ...
 *	\z\dpso\addons\glasses\functions\blindfold\fn_blindfold_canRemove.sqf
 *	by Ojemineh
 *
 ...
 *
 *	Example:
 *	[_player, _target] call DPSO_glasses_fnc_blindfold_canRemove;
 *
 */
...
_return = (
	((goggles _target) in ["DPSO_Blindfold_Black", "DPSO_Blindfold_White", "DPSO_Blindfold_White_Blood"]) &&
	(alive _caller) &&
