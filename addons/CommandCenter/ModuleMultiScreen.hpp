class DPSO_ModuleMultiScreen: Module_F
{
	scope = 2;
	displayName = "Setup Multi Screen";
	icon = "\z\dpso\addons\media\images\icons\MultiScreen.paa";
	category = "DPSO_CommandCenter";
	function = "DPSO_fnc_moduleMultiScreen";
	functionPriority = 4;
	isGlobal = 0;
	...
	class Attributes: AttributesBase
	{
		...
		class MultiScreenDrone: Checkbox
  		{
				property = "DPSO_MultiScreenDrone";
		...
		class MultiScreenSelections: Edit
  		{
				property = "DPSO_MultiScreenSelections";
