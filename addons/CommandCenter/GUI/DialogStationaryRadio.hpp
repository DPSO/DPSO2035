class RadioConfigDialog {
    ...
    class controls {
        ...
        class ChOneText: DPSO_CC_RscText
        {
        	idc = 1002;
        ...
        class ChTwoText: DPSO_CC_RscText
        {
        	idc = 1003;
        ...
        class ButtonOK: DPSO_CC_RscButton
        {
			idc = 1100;
        	x = 10 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X;
        ...
        class ChOneEdit: DPSO_CC_RscEdit
        {
        	idc = 1400;
        	text = "30";
        ...
        class ChTwoEdit: DPSO_CC_RscEdit
        {
        	idc = 1401;
        	text = "40";
        	x = 26 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X;
