...
} forEach (cTabHcamlist + DPSO_CC_vehicleCamList);
...
[_object, _selection] call DPSO_fnc_deleteCamera;
...
_object setVariable [format ["DPSO_CC_screen_%1_Cam", _selection], [_cam, objNull, _host]];