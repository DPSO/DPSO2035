class zen_context_menu_actions {
    class FOBParent {
        ...
        icon = "";
        statement = "";
        condition = "_hoveredEntity call dpso_fnc_canBeFOB";
        priority = 50;
        class FOBCamp {
            displayName = "Camp";
            icon = "";
            statement = "[_args] call dpso_fnc_FOBZeusWrapper";
            priority = 50;
            args = 0;
        };
    ...
    class MedFacility {
        ...
        statement = "[_hoveredEntity] remoteExec [""dpso_fnc_setMedicalFacility"", 0, true]";
        condition = "_hoveredEntity call dpso_fnc_canBeMedFacility";
        priority = 52;
    };
    ...
    class RepFacility {
        ...
        statement = "[_hoveredEntity] remoteExec [""dpso_fnc_setRepairFacility"", 0, true]";
        condition = "_hoveredEntity call dpso_fnc_canBeMedFacility";
        priority = 51;
    };
    ...
    class MakeIED {
        ...
        statement = "call dpso_fnc_MakeIEDZeusWrapper";
