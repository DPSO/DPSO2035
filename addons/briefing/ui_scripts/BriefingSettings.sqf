...
switch _mode do {
    ...
    case "refreshBriefTree": {
        ...
        fn_BriefTreeProcessUnit = {
            ...
            if (_doSpeak) then {
                _ctrlTree tvSetPictureRight [_location, "z\dpso\addons\briefing\UI\check_small_ca.paa"];
                _returnCode = 0;
            } else {
                _ctrlTree tvSetPictureRight [_location, "z\dpso\addons\briefing\UI\plus_small_ca.paa"];
            };
