class DPSO_ModuleSingleScreen: Module_F
{
	scope = 2;
	displayName = "Setup Single Screen";
	icon = "\z\dpso\addons\media\images\icons\SingleScreen.paa";
	category = "DPSO_CommandCentre";
	function = "DPSO_fnc_moduleSingleScreen";
	functionPriority = 4;
	isGlobal = 0;
	...
	class Attributes: AttributesBase
	{
		...
		class SingleScreenDrone: Checkbox
  		{
				property = "DPSO_SingleScreenDrone";
		...
		class SingleScreenSelection: Edit
  		{
				property = "DPSO_SingleScreenSelection";
