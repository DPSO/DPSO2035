class DPSO_ModuleStationaryRadio: Module_F
{
	scope = 2;
	displayName = "Setup Stationary Radio";
	icon = "\z\dpso\addons\media\images\icons\StationaryRadio.paa"; //todo: proper icon
	category = "DPSO_CommandCentre";
	function = "DPSO_fnc_moduleStationaryRadio";
	functionPriority = 4;
	isGlobal = 0;
	...
	class Attributes: AttributesBase
	{
		class StationaryRadioOn: Checkbox
  		{
				property = "DPSO_StationaryRadioOn";
		...
		class StationaryRadioCh1: Edit
  		{
				property = "DPSO_StationaryRadioCh1";
		...
		class StationaryRadioCh2: Edit
  		{
				property = "DPSO_StationaryRadioCh2";
		...
		class StationaryRadioVol: Edit
  		{
				property = "DPSO_StationaryRadioVol";
		...
		class StationaryRadioClass: Edit
  		{
				property = "DPSO_StationaryRadioClass";
		...
		class StationaryRadioCode: Edit
  		{
				property = "DPSO_StationaryRadioCode";
