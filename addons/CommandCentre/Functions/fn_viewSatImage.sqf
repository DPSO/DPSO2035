...
// set the mode
_object setVariable [format ["DPSO_CC_screen_%1_mode", _selection], "SAT", true];
...
[_object, _selection, _renderTarget, _data] remoteExec ["DPSO_fnc_viewSatGlobal", 0, _screen_JIP_id];
...
_object setVariable [format ["DPSO_CC_screen_%1_visionMode", _selection], 0, true];
