...
private _configAction = [
	...
	},
	{
		...
		_object getVariable [format ["DPSO_CC_screen_%1_on", _selection], false];
	},
	nil,
...
private _turnOnAction = [
	...
	"",
	{
		...
		[_object, _selection, true, _args] call DPSO_fnc_turnOnScreen;
	},
	{
		params ["_target", "_player", "_params"];
		_params params ["_object", "_selection"];
...
private _turnOffAction = [
	...
	"",
	{
		...
		[_object, _selection, false, _args] call DPSO_fnc_turnOnScreen;
	},
	{
		params ["_target", "_player", "_params"];
		_params params ["_object", "_selection"];
...
private _toggleVisualAction = [
	...
	"",
	{
		...
		[_object, _selection] call DPSO_fnc_toggleVisualMode;
	},
	{
		params ["_target", "_player", "_params"];
		_params params ["_object", "_selection"];
