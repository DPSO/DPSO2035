...
/*
    ...
    switch (true) do {case (_playerUID in ACE_ENG)          : { player setVariable ["ace_isEngineer",1, true];};};
    switch (true) do {case (_playerUID in ACE_AENG)         : { player setVariable ["ace_isEngineer",2, true];};};
    switch (true) do {case (_playerUID in USE_SSS_CAS)      : { player setVariable ["canUseSSScas",true,true];};};
