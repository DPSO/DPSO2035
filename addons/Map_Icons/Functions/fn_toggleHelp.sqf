...
/*
Function: DPSO_MI_fnc_toggleHelp
...
DPSO_MI_helpEnabled = !(missionNamespace getVariable ["DPSO_MI_helpEnabled",false]);
...
_ctrlHelpPos set [3,[1 * Y_FACTOR,22.2 * Y_FACTOR] select DPSO_MI_helpEnabled];
