/*
Function: DPSO_MI_fnc_createMarkerPreview
...
private _previewMarkers = missionNamespace getVariable ["DPSO_MI_previewMarkers",[]];
...
DPSO_MI_previewMarkers = [];
{
    ...
    DPSO_MI_previewMarkers pushBack _marker;
