 ...
 *	\z\dpso\addons\gear\functions\common\fn_set.sqf
 *	by Ojemineh
 *
 *	set unit role
 *
 ...
 *
 *	Example:
 *	[player, "curator", "0", "nato"] call DPSO_gear_fnc_set;
 *
 */
...
if (Not local _unit) exitWith {
	[_unit, _role, _type, _team, _load] remoteExecCall ["DPSO_gear_fnc_set", _unit];
};
...
if (_load) then { [_unit] call DPSO_gear_fnc_load; };
