 ...
 *	\z\dpso\addons\gear\functions\common\fn_initPlayer.sqf
 *	by Ojemineh
 *
 *	initialize player
 *
 ...
 *
 *	Example:
 *	[player] call DPSO_gear_fnc_initPlayer;
 *
 */
...
if (Not local _unit) exitWith {
	[_unit] remoteExecCall ["DPSO_gear_fnc_initPlayer", _unit];
};
...
[_unit, _gear_role, _gear_type, _gear_team] call DPSO_gear_fnc_load;
