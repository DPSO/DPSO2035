 ...
 *	\z\dpso\addons\gear\functions\load\fn_load.sqf
 *	by Ojemineh
 *
 *	load files
 *
 ...
 *
 *	Example:
 *	[player, "curator"] call DPSO_gear_fnc_load;
 *
 */
...
if (Not local _unit) exitWith {
	[_unit, _role, _type, _team] remoteExecCall ["DPSO_gear_fnc_load", _unit];
};
...
if (GEAR_KEEP_GOGGLES) then {
	if ((goggles _unit) != "") then {
		_unit setVariable ["DPSO_gear_goggles", (goggles _unit)];
	};
};

// -------------------------------------------------------------------------------------------------

[_unit] call DPSO_gear_fnc_removeAll;

[_unit, _role, _type, _team] call DPSO_gear_fnc_load_loadout;
[_unit, _role, _type, _team] call DPSO_gear_fnc_load_properties;
