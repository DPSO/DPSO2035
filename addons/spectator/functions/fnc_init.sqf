...
GVAR(interfaceControls) = [
        IDC_SPECTATOR_DPSO_SPECTATOR_KILLIST, IDC_SPECTATOR_DPSO_SPECTATOR_UNITLABEL,
        IDC_SPECTATOR_DPSO_SPECTATOR_UNITLIST, IDC_SPECTATOR_DPSO_SPECTATOR_VISION,
        IDC_SPECTATOR_DPSO_SPECTATOR_FILTER, IDC_SPECTATOR_DPSO_SPECTATOR_BUTTON,
        IDC_SPECTATOR_DPSO_SPECTATOR_TAGS, IDC_SPECTATOR_DPSO_SPECTATOR_VIEW,
        IDC_SPECTATOR_DPSO_SPECTATOR_COMPASS, IDC_SPECTATOR_DPSO_SPECTATOR_COMPASSLEFT,
        IDC_SPECTATOR_DPSO_SPECTATOR_COMPASSRight, IDC_SPECTATOR_DPSO_SPECTATOR_MUTE,
        IDC_SPECTATOR_DPSO_SPECTATOR_RADIO, IDC_SPECTATOR_DPSO_SPECTATOR_MENUBACK
];
...
if !([] call dpso_common_fnc_isAdmin) then {
