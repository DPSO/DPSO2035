 ...
 *	\common\functions\common\fn_weaponLock.sqf
 *	by Ojemineh
 *
 *	weapon saftey lock
 *
 ...
 *
 *	Example:
 *	[player, (primaryWeapon player), (primaryWeapon player)] call DPSO_fnc_weaponLock;
 *
 */
...
if (_showHint) then {
	[_unit, _weapon] call DPSO_fnc_weaponFiremodeSound;
