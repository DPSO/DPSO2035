 ...
 *	\common\functions\common\fn_weaponUnlock.sqf
 *	by Ojemineh
 *
 *	weapon saftey lock
 *
 ...
 *
 *	Example:
 *	[player, (primaryWeapon player), (primaryWeapon player)] call DPSO_fnc_weaponUnlock;
 *
 */
...
if (inputAction "nextWeapon" > 0) then {
	...
	[_unit, _weapon, _muzzle] call DPSO_fnc_weaponFiremodeSound;
};
