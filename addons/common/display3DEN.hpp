        ...
        class MenuStrip: ctrlMenuStrip {
            class Items {
                ...
                class DPSO_Documentation {
                    text = "DPSO Docs"; // engine adds ... to links
                    data = "HelpFeedback";
                ...
                class DPSO_Toolbar_Controls: ctrlControlsGroupNoScrollbars {
                    ...
                    class Controls {
                        class Garrison: ctrlCheckboxToolbar {
                            ...
                            textureUnchecked="\z\dpso\addons\media\images\logo_dpso_small_ca.paa";
                            textureFocusedChecked="\z\dpso\addons\media\images\logo_dpso_small_glow_ca.paa";
                            textureFocusedUnchecked="\z\dpso\addons\media\images\logo_dpso_small_ca.paa";
                            textureHoverChecked="\z\dpso\addons\media\images\logo_dpso_small_glow_ca.paa";
                            textureHoverUnchecked="\z\dpso\addons\media\images\logo_dpso_small_ca.paa";
                            texturePressedChecked="\z\dpso\addons\media\images\logo_dpso_small_glow_ca.paa";
                            texturePressedUnchecked="\z\dpso\addons\media\images\logo_dpso_small_ca.paa";
                            textureDisabledChecked="\z\dpso\addons\media\images\logo_dpso_small_glow_ca.paa";
                            textureDisabledUnchecked="\z\dpso\addons\media\images\logo_dpso_small_ca.paa";
                        };
                    };
                };
            };
