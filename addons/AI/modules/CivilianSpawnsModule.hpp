class DPSO_ModuleCivilianSpawns: Module_F
{
	scope = 2;
	...
	class Attributes: AttributesBase
	{
		...
		{
			property = "DPSO_AI_GarrisonedUnitsMin";
		...
		{
			property = "DPSO_AI_GarrisonedUnitsMax";
		...
		{
			property = "DPSO_AI_CivPedPatrolsMin";
		...
		{
			property = "DPSO_AI_CivPedPatrolsMax";
		...
		{
			property = "DPSO_AI_CivVehPatrolsMin";
		...
		{
			property = "DPSO_AI_CivVehPatrolsMax";
		...
		{
			property = "DPSO_AI_CivVehParkedMin";
		...
		{
			property = "DPSO_AI_CivVehPaarkedMax";
