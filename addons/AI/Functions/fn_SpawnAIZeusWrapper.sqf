...
#define EAST_FACTIONS ["Vanilla - CSAT", "Vanilla - CSAT (Pacific)", "@Project OPFOR - African Militia", "@Project OPFOR - Middle Eastern Militia", "@Project OPFOR - Boko Haram", "@Project OPFOR - ChDKZ", "@Project OPFOR - Irish Republican Army", "@Project OPFOR - Islamic State", "@Project OPFOR - Sahrani Liberation Army", "@Project OPFOR - Takistani Armed Forces", "@RHS AFRF - Russia - MSV", "@RHS AFRF - Russia - VDV", "@RHS AFRF - Russia - VMF", "@RHS GREF - ChDKZ Insurgents", "@Taliban RHS Config - Taliban"]
