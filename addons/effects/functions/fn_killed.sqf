...
if (isNull _crash && {!isNull objectParent _killer}) exitWith {
        ...
        playSound [(selectRandom dpso_crash_sfx),true];
        //(vehicle _killer) say3d (selectRandom dpso_crash_sfx);
    }; 
*/
// surface
...
_sound = switch (_surfaceType) do {
    ...
    case "#GdtGrassGreen": {selectRandom dpso_unit_sfx_bodyfall_grass};

    case "#GdtStratisThistles";
    case "#GdtStratisDryGrass";
    case "#GdtGrassDry": {selectRandom dpso_unit_sfx_bodyfall_drygrass};

    case "#GdtStratisDirt";
    case "#GdtDirt";
    case "#GdtStratisConcrete";
    case "#GdtConcrete";
    default {selectRandom dpso_unit_sfx_bodyfall_concrete};
};
