...
private _QS_ST_iconShadowMap = uiNamespace getVariable ["DPSO_QS_ST_iconShadowMap", 0];										// NUMBER. Icon Shadow on MAP. 0 = no shadow. 1 = shadow. 2 = outline. Must be 0, 1, or 2. Default 1.
...
private _QS_ST_iconShadowGPS = uiNamespace getVariable ["DPSO_QS_ST_iconShadowGPS", 0];										// NUMBER. Icon Shadow on GPS. 0 = no shadow. 1 = shadow. 2 = outline. Must be 0, 1, or 2. Default 1.
