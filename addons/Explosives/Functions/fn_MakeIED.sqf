...
Description:
	...
	DPSO_fnc_IEDVehicle for a vanilla alternative, restricted to land vehicles.
...
if (hasInterface && {
	...
	[
		...
		_condition,
		"true",
		{["You've started disarming the IED.", [-1, 0.8], "#339900", 0.5, false] call DPSO_fnc_dynamicText;},
		{["Disarming the IED.", [-1, 0.8], "#339900", 0.5, false] call DPSO_fnc_dynamicText;},
		{
			(_this select 0) setVariable ["IEDdisarmed", true, true];
			["You've disarmed the IED.", [-1, 0.8], "#339900", 0.5, false] call DPSO_fnc_dynamicText;
		},
		{["The IED was not disarmed.", [-1, 0.8], "#339900", 0.5, false] call DPSO_fnc_dynamicText;},
		[],
		10 + random 10,
		true,
		"Disarming IED",
