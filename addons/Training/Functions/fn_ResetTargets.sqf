/*
Function: DPSO_fnc_ResetTargets
...
Examples:
	(begin example)
		[this, "Reset Targets", [1200,4200,0], 250] call DPSO_fnc_ResetTargets;
		[MyLaptopName, "Reset 300m Range", [5500,3522,0], 300] call DPSO_fnc_ResetTargets;
	(end)
...
[_center,_distance] call DPSO_fnc_SetTargets;	// Initial Reset.
...
[
	...
	{},
	{
		[(_this select 3) select 2, (_this select 3) select 3] call DPSO_fnc_SetTargets;
