...
class CLASS(Box_Uniforms): B_supplyCrate_F {
    ...
    class TransportItems {
        ...
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_DPSO_ATX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_DPSO_AUX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_DPSO_IX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_LS_DPSO_LEX),10);
        ...
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_DPSO_ATX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_DPSO_AUX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_DPSO_IX),10);
        MACRO_ADDITEM(CLASS(Uniform_Combat_RS_DPSO_LEX),10);
