...
class CLASS(Unit_Underwear_Black): B_Soldier_base_F {
    MACRO_UNDERWEAR_BASE
    author = "Pomigit, Jonpas, Rory";
    uniformClass = QCLASS(Underwear_Black);
    hiddenSelectionsTextures[] = {QPATHTOF(data\underwear_black_co.paa)};
};
class CLASS(Unit_Underwear_White): B_Soldier_base_F {
    MACRO_UNDERWEAR_BASE
    author = "Pomigit, Jonpas, Rory";
    uniformClass = QCLASS(Underwear_White);
    hiddenSelectionsTextures[] = {QPATHTOF(data\underwear_white_co.paa)};
};
class CLASS(Unit_Underwear_Blue): B_Soldier_base_F {
    MACRO_UNDERWEAR_BASE
    author = "Pomigit, Jonpas, Rory";
    uniformClass = QCLASS(Underwear_Blue);
    hiddenSelectionsTextures[] = {QPATHTOF(data\underwear_blue_co.paa)};
};
class CLASS(Unit_Underwear_Green): B_Soldier_base_F {
    MACRO_UNDERWEAR_BASE
    author = "Pomigit, Jonpas, Rory";
    uniformClass = QCLASS(Underwear_Green);
    hiddenSelectionsTextures[] = {QPATHTOF(data\underwear_green_co.paa)};
};
...
// Combat - Long Sleeves - DPSO
class CLASS(Unit_Combat_LS_DPSO_Base): CLASS(Unit_Combat_LS_Base) {
    hiddenSelectionsMaterials[] = {QPATHTOF(data\uniform_combat_DPSO.rvmat)};
};
...
// Combat - Rolled Sleeves - DPSO
class CLASS(Unit_Combat_RS_DPSO_Base): CLASS(Unit_Combat_RS_Base) {
    hiddenSelectionsMaterials[] = {QPATHTOF(data\uniform_combat_DPSO.rvmat)};
};
