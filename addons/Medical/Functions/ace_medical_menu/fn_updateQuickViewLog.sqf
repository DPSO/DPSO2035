 ...
 *	\z\dpso\addons\medical\functions\ace_medical_menu\fn_updateQuickViewLog.sqf
 *	by Ojemineh
 *
 *	overwrite ace medical menu updateQuickViewLog
 *
 *	Arguments:
 *	0: display	- <CONTROL>
 *	1: logs		- <ARRAY>
 ...
 *
 *	Example:
 *	[bob, kevin] call ACE_medical_menu_fnc_updateQuickViewLog;
 *
 */
