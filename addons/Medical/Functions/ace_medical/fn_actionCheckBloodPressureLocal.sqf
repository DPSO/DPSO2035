 ...
 *	\z\dpso\addons\medical\functions\ace_medical\fn_actionCheckBloodPressureLocal.sqf
 *	by Ojemineh
 *
...
if ([_medic] call ACE_medical_fnc_isMedic) then {
	...
	if (_bloodPressureHigh > 1) then {
		_output = localize "STR_DPSO_Medical_Check_Bloodpressure_Output_1";
		_logOutPut = format ["%1/%2", round _bloodPressureHigh, round _bloodPressureLow];
	} else {
		_output = localize "STR_DPSO_Medical_Check_Bloodpressure_Output_4";
		_logOutPut = localize "STR_DPSO_Medical_Check_Bloodpressure_None";
	};
    ...
    //if (_bloodPressureHigh > 20) then {
    if (_bloodPressureHigh > 1) then {
        _output = localize "STR_DPSO_Medical_Check_Bloodpressure_Output_2";
		...
		_output = localize "STR_DPSO_Medical_Check_Bloodpressure_Output_4";
		_outputEx = format ["<t color='#ff0000'>%1</t>", localize "STR_DPSO_Medical_Check_Bloodpressure_None"];
		_logOutPut = localize "STR_DPSO_Medical_Check_Bloodpressure_None";
    };
