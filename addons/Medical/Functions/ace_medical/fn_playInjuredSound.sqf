 ...
 *	\z\dpso\addons\medical\functions\ace_medical\fn_playInjuredSound.sqf
 *	by Ojemineh
 *
...
if (_pain > 0 && {[_unit] call ACE_common_fnc_isAwake}) exitWith {
	...
	[_sound, _unit, AGLToASL (_unit modelToWorld (_unit selectionPosition "head")), 30, 1.4, 1, false] call DPSO_fnc_playSound3d;
