 ...
 *	\z\dpso\addons\medical\functions\ace_medical\fn_useItem.sqf
 *	by Ojemineh
 *
...
private _usageMedics = missionNamespace getVariable ["DPSO_medical_usage_order_medics", 0];
private _usageResponder = missionNamespace getVariable ["DPSO_medical_usage_order_responder", 0];
