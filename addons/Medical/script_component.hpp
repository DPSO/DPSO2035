...
#define ALL_MEDICAL_ITEMS [\
    ...
    "AFMED_apap",\
    "kat_X_AED", "kat_Painkiller", "kat_chestSeal", "kat_larynx", "kat_guedel", "kat_accuvac", "kat_AED", "kat_Pulseoximeter",\
    "DPSO_MedicKit", "DPSO_FirstAid", "DPSO_MedicArea", "DPSO_Stethoscope"\
]
