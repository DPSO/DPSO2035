...
/* ----------------------------------------------------------------------------
Internal Function: DPSO_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call DPSO_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_DPSO_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[DPSO Adminmenu] Printed entry: %1%2",
