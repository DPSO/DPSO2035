...
private _markerName = ctrlText (_display displayCtrl IDC_DPSO_ADMINMENU_RESP_GROUPMARKERNAME);
private _markerType = lbCurSel (_display displayCtrl IDC_DPSO_ADMINMENU_RESP_MARKERTYPE); // type == -1 if no spawn marker
private _markerColor =lbCurSel (_display displayCtrl IDC_DPSO_ADMINMENU_RESP_MARKERCOLOUR);
