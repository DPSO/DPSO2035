...
/* ----------------------------------------------------------------------------
Function: DPSO_acre2_fnc_testBabel
...
if (getmissionconfigvalue ["DPSO_AcreBabelEnabled",false]) then {
    ...
    private _babelArray = getMissionConfigValue ["DPSO_AcreBabelSettings", []];
...

    {
        ...
        if (_index == -1) then {
            ...
            private _groupCond = _grp getVariable ["DPSO_BabelLanguages", []];
