...
switch _mode do {
    case "onLoad": {
        ...
        DPSO_AcreAddRadioActions_Array = ("DPSO_MissionAcre2Attributes" get3DENMissionAttribute "DPSO_AcreAddRadioActions");
        if (DPSO_AcreAddRadioActions_Array isEqualType "") then {
            DPSO_AcreAddRadioActions_Array = call compile DPSO_AcreAddRadioActions_Array;
        };
        ...
        _ctrlList lnbSetColumnsPos [0.1,0.2];
        {
            ...
            _alpha = if (_x in DPSO_AcreAddRadioActions_Array) then {1} else {0.5};
            _ctrlList lnbsetcolor [[_lnbAdd,1],[1,1,1,_alpha]];
        } forEach ACRE_RADIO_CLASSNAME_ARRAY;
    };
    case "attributeSave": {
        str (uiNamespace getVariable "DPSO_AcreAddRadioActions_Array")
    };
    case "listModify": {
        ...
        if (_radio in DPSO_AcreAddRadioActions_Array) then {
            DPSO_AcreAddRadioActions_Array = DPSO_AcreAddRadioActions_Array - [_radio];
        } else {
            DPSO_AcreAddRadioActions_Array pushBackUnique _radio;
        };
        lnbclear _ctrlList;
        _ctrlList lnbSetColumnsPos [0.1,0.2];
        {
