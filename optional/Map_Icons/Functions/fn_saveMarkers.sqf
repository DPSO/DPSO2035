/*
Function: DPSO_MI_fnc_saveMarkers
...
if (isNil "_saveMarkersData") then {
    profileNamespace setVariable ["DPSO_MI_saveData",[]];
    _saveMarkersData = profileNamespace getVariable "DPSO_MI_saveData";
};
...

{
    _thisDataMarkersArray pushBack [
        ...
        markerText _x,
        markerType _x,
        [_x] call DPSO_MI_fnc_getMarkerChannel
    ];
