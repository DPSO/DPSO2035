...
if (_on) then {
    ...
    _trg setTriggerStatements [
        "(DPSO_unit getVariable ['cbrn_damage', 0] > 0) && {DPSO_unit in thisList}",
        "
            DPSO_unit setVariable ['cbrn_stoppedAutoDamage', true];
            DPSO_unit setVariable ['cbrn_damage', 0];
            [DPSO_unit, false] call ace_medical_status_fnc_setCardiacArrestState;
            [DPSO_unit, false] call ace_medical_status_fnc_setUnconsciousState;
