...
private _action = ["cbrn_turn_on_oxygen", "Turn on oxygen","",{
    [DPSO_unit] call cbrn_fnc_startOxygen;
},{
    private _player = DPSO_unit;
...
_action = ["cbrn_turn_off_oxygen", "Turn off oxygen","",{
    DPSO_unit setVariable ["cbrn_oxygen", false];
},{
    DPSO_unit getVariable ["cbrn_oxygen", false]
},{},[], [0,0,0], 3] call ace_interact_menu_fnc_createAction;
["CAManBase", 1, ["ACE_SelfActions","ACE_Equipment"], _action, true] call ace_interact_menu_fnc_addActionToClass;
...
_action = ["cbrn_check_oxygen", "Check remaining oxygen","",{
    ...
    }, [DPSO_unit]] call CBA_fnc_execNextFrame;
},{
    DPSO_unit getVariable ["cbrn_backpack_on", false];
},{},[], [0,0,0], 3] call ace_interact_menu_fnc_createAction;
["CAManBase", 1, ["ACE_SelfActions","ACE_Equipment"], _action, true] call ace_interact_menu_fnc_addActionToClass;
...
DPSO_unit addEventHandler ["Killed", {
    params ["_unit"];
...
DPSO_unit addEventHandler ["Respawn", {
    DPSO_unit setVariable ["cbrn_damage", nil];
    DPSO_unit setVariable ["cbrn_autoDamage", nil];
    DPSO_unit setVariable ["cbrn_stoppedAutoDamage", nil];
    DPSO_unit getVariable ["cbrn_using_threat_meter", nil];
    DPSO_unit setVariable ["cbrn_oxygen", nil];
}];

_action = ["cbrn_turn_check_damage", "Check CRBN Exposure","",{
    private _damage = DPSO_unit getVariable ["cbrn_damage", 0];
    ...
    {local DPSO_unit},{},[], [0,0,0], 3] call ace_interact_menu_fnc_createAction;
...
_action = ["cbrn_turn_on_threatmeter", "Turn on threatmeter","",{
    DPSO_unit setVariable ["cbrn_using_threat_meter", true, true];
},{
    !(DPSO_unit getVariable ["cbrn_using_threat_meter", false]) && {DPSO_unit getVariable ["cbrn_hasThreatMeter", false]}
},{},[], [0,0,0], 3] call ace_interact_menu_fnc_createAction;
["CAManBase", 1, ["ACE_SelfActions","ACE_Equipment"], _action, true] call ace_interact_menu_fnc_addActionToClass;
_action = ["cbrn_turn_off_threatmeter", "Turn off threatmeter","",{
    DPSO_unit setVariable ["cbrn_using_threat_meter", false, true];
},{
    DPSO_unit getVariable ["cbrn_using_threat_meter", false]
},{},[], [0,0,0], 3] call ace_interact_menu_fnc_createAction;
["CAManBase", 1, ["ACE_SelfActions","ACE_Equipment"], _action, true] call ace_interact_menu_fnc_addActionToClass;
...
DPSO_unit createDiaryRecord ["Credits", ["CBRN Mechanic",
...
if !(isNil "CBA_fnc_addItemContextMenuOption") then {
    {
        ...
        [{DPSO_unit getVariable ["cbrn_oxygen", false]}, {DPSO_unit getVariable ["cbrn_oxygen", false]}], {
            DPSO_unit setVariable ["cbrn_oxygen", false];
            false
        }, false] call CBA_fnc_addItemContextMenuOption;

        [_x, "BACKPACK", "Check remaining oxygen", nil, nil,
        [{true}, {DPSO_unit getVariable ["cbrn_backpack_on", false]}], {
            [{
                params ["_unit"];
                [_unit] call cbrn_fnc_checkOxygen;
            }, [DPSO_unit]] call CBA_fnc_execNextFrame;
    ...
    [{!(DPSO_unit getVariable ["cbrn_using_threat_meter", false]) && {DPSO_unit getVariable ["cbrn_hasThreatMeter", false]}},{!(DPSO_unit getVariable ["cbrn_using_threat_meter", false]) && {DPSO_unit getVariable ["cbrn_hasThreatMeter", false]}}], {
        DPSO_unit setVariable ["cbrn_using_threat_meter", true, true];
        false
    }, false] call CBA_fnc_addItemContextMenuOption;

    [cbrn_threatMeteritem, "CONTAINER", "Turn off threatmeter", nil, nil,
    [{DPSO_unit getVariable ["cbrn_using_threat_meter", false]},{DPSO_unit getVariable ["cbrn_using_threat_meter", false]}], {
        DPSO_unit setVariable ["cbrn_using_threat_meter", false, true];
        false
    }, false] call CBA_fnc_addItemContextMenuOption;
};
