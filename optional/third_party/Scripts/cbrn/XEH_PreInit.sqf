...
["cbrn_createZone", {
    ...
    _trg setTriggerStatements ["thisTrigger getVariable ['cbrn_active',false] && {this && {(vehicle DPSO_unit) in thisList}}", "[thisTrigger, DPSO_unit, true] call cbrn_fnc_addZone", "[thisTrigger, DPSO_unit, false] call cbrn_fnc_addZone"];
