...
def main():
    ...
    print("""
  ######################################
  # dpso Development Environment Setup #
  ######################################

  This script will create your dpso dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your dpso project folder:
    [Arma 3 installation directory]\\{} => dpso project folder
    P:\\{}                              => dpso project folder
