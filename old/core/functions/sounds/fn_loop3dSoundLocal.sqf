 ...
 *	\z\dpso\addons\core\functions\sounds\fn_loop3dSoundLocal.sqf
 *	by Ojemineh
 *
 ...
 *
 *	Example:
 *	[player, "AlarmBell", [], -1, -1, 6] call DPSO_fnc_loop3dSoundLocal;
 *
 */
...
if (_soundInUse) exitWith {
	[_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] spawn {
		...
		sleep 0.1;
		[_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] call DPSO_fnc_loop3dSoundLocal;
	};
};
