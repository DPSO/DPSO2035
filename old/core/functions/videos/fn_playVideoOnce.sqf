 ...
 *	\z\dpso\addons\core\functions\videos\fn_playVideoOnce.sqf
 *	by Ojemineh
 *	
 ...
 *	
 *	Example:
 *	["intro.ogv"] call DPSO_fnc_playVideoOnce;
 *	
 */
...
private _return = [_filename, _videoID, _canSkip, _showSkip, _showTime] spawn {
	...
	private _videoTag = format ["DPSO_Video_%1", _videoID];
	...
	private _keyHandler = (findDisplay 46) displayAddEventHandler ["KeyDown", "_this call DPSO_fnc_videoKeyDown"];
