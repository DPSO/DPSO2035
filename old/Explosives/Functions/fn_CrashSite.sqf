...
Examples:
	(begin example)
		["", [CrashPlane, getPos crashSite]] call DPSO_fnc_crashSite;
		["", [MyPlane, [1234,4321,0]]] call DPSO_fnc_crashSite;
	(end)
...
switch (_stage) do {
	case "init": {
		...
		[
			{
				["fadeOut", _this] call DPSO_fnc_crashSite;
	...
	case "fadeOut": {
		...
		[
			{
				["fadeSound", _this] call DPSO_fnc_crashSite;
			}, _args, 9
		] call CBA_fnc_waitAndExecute;
	};
	...
	case "fadeSound": {
    	...
    	[
    	  	{
    	    	["teleport", _this] call DPSO_fnc_crashSite;
    	  	}, _args, 2
    	] call CBA_fnc_waitAndExecute;
	};
...
//	        _x setVelocity [0, 0, 0];
      	...
      	[
      		{
      	    	["woundAndEnable", _this] call DPSO_fnc_crashSite;
      	  	}, _args, 1
      	] call CBA_fnc_waitAndExecute;
  	};
  	...
  	case "woundAndEnable": {
    	...
    	[
    	  	{
    	    	["effects", _this] call DPSO_fnc_crashSite;
    	  	}, _args, 3
    	] call CBA_fnc_waitAndExecute;
  	};
  	...
  	case "effects": {
    	...
    	[
      		{
        		["finish", _this] call DPSO_fnc_crashSite;
	      	}, _args, 1
    	] call CBA_fnc_waitAndExecute;
	};
	...
	default {
		["init", _args] call DPSO_fnc_crashSite;
	};
};