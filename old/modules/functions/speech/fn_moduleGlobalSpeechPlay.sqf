 ...
 *	\z\dpso\addons\modules\functions\speech\fn_moduleGlobalSpeechPlay.sqf
 *	by Ojemineh
 *	
 *	module function
 *	
 ...
 *	
 *	Example:
 *	[] call DPSO_fnc_moduleGlobalSpeechPlay;
 *	
 */
...
[_logic, _caller, _target, _source, _sound, _distance, _maxDistance, _duration, _onlyOnce, _reaction, _animation, _codeStart, _codeEnd] spawn {
	...
	if (_onlyOnce) then {_target setVariable ["dpso_playedOnce", true, true];};
	...
	[_target, _sound, _distance, _maxDistance, _duration, 1, true] call DPSO_fnc_speak3d;
	...
	waitUntil {if (!(_target getVariable ["dpso_speak3d", false])) exitWith {true}; false};
