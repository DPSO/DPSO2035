...
// set the mode
_object setVariable [format ["DPSO_CC_screen_%1_mode", _selection], "HCAM", true];
...
[_object, _selection, _renderTarget, _data] remoteExec ["DPSO_fnc_viewHCamGlobal", 0, _screen_JIP_id];
