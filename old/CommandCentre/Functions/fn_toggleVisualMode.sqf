...
private _currentVM = _object getVariable [format ["DPSO_CC_screen_%1_visionMode", _selection], 0];
...
_object setVariable [format ["DPSO_CC_screen_%1_visionMode", _selection], _nextVM, true];