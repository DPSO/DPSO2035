...
class respawnMenuDialog {
    idd = 26893;
    movingEnable = 0;
    onLoad="['onLoad'] spawn dpso_respawn_fnc_handleRespawnUI;";
    ...
    class controls { 
        ...
        class respawnMenuAddButton: respawnMenu_RscButton
        {
            ...
            w = 0.04125 * safezoneW;
            h = 0.055 * safezoneH;
            action="['respawnMenuAddAction'] spawn dpso_respawn_fnc_handleRespawnUI";
        };
        class respawnMenuRemoveButton: respawnMenu_RscButton
        {
            ...
            w = 0.04125 * safezoneW;
            h = 0.055 * safezoneH;
            action="['respawnMenuRemoveAction'] spawn dpso_respawn_fnc_handleRespawnUI";
        };
        class respawnMenuSpawnButton: respawnMenu_RscButton
        {
            ...
            h = 0.044 * safezoneH;
            action="['respawnMenuRespawnAction'] spawn dpso_respawn_fnc_handleRespawnUI";
        };
        class respawnMenuChangeRoleButton: respawnMenu_RscButton
        {
            ...
            h = 0.055 * safezoneH;
            action="['respawnMenuChangeRoleAction'] spawn dpso_respawn_fnc_handleRespawnUI";
        };
        class respawnMenuChangeRankButton: respawnMenu_RscButton
        {
            ...
            w = 0.0567187 * safezoneW;
            h = 0.055 * safezoneH;
            action="['respawnMenuChangeRankAction'] spawn dpso_respawn_fnc_handleRespawnUI";
        };
        ...
        class respawnMenuVOIP: respawnMenu_RscButton
        {
            ...
            action = "['toggleSpectator'] spawn dpso_respawn_fnc_handleRespawnUI";
        };
...
class respawnMenuMapDialog {
    ...
    class controls { 
        class FullRespawnMap : RscMapControl
        {
            ...
            w = 1 * safezoneW;
            h = 1 * safezoneH;
            onDraw = "_this call dpso_respawn_fnc_respawnDrawMapIcons";
            onSetFocus = "['respawnMapLoaded'] spawn dpso_respawn_fnc_handleRespawnUI";
            onMouseButtonDown = "['respawnMap_onMouseButtonDown',_this] spawn dpso_respawn_fnc_handleRespawnUI";
            onKeyUp = "['respawnMap_keyUp',_this] spawn dpso_respawn_fnc_handleRespawnUI";
        };
    };
};