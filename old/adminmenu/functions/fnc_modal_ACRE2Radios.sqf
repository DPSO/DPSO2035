...
_ctrlLabelRadios ctrlSetPosition [0, 0, (0.5 * _ctrlGrpWidth), DPSO_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRadioGroup ctrlSetPosition [0, (1.1 * DPSO_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, DPSO_ADMINMENU_STD_HEIGHT];
...
private _radioCtrls = [];
private _radioCtrlsY = 2.2 * DPSO_ADMINMENU_STD_HEIGHT;

{
    ...
    _ctrlRadioCheck ctrlSetPosition [0, _radioCtrlsY + (_forEachIndex * DPSO_ADMINMENU_STD_HEIGHT), DPSO_ADMINMENU_STD_WIDTH, DPSO_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlRadioName ctrlSetPosition [DPSO_ADMINMENU_STD_WIDTH, _radioCtrlsY + (_forEachIndex * DPSO_ADMINMENU_STD_HEIGHT), (0.5 * _ctrlGrpWidth) - DPSO_ADMINMENU_STD_WIDTH, DPSO_ADMINMENU_STD_HEIGHT];
...
if (!isNil QEGVAR(acre2,networksWithRadioChannels)) then {
    ...
    _ctrlCheckNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, 0, DPSO_ADMINMENU_STD_WIDTH, DPSO_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetwork ctrlSetPosition [(0.5 * _ctrlGrpWidth) + DPSO_ADMINMENU_STD_WIDTH, 0, (0.5 * _ctrlGrpWidth) - (1.1 * DPSO_ADMINMENU_STD_WIDTH), DPSO_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetworkWarning ctrlSetPosition [0.5 * _ctrlGrpWidth, (1.1 * DPSO_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, DPSO_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlListNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, _radioCtrlsY, (0.5 * _ctrlGrpWidth) - (0.1 * DPSO_ADMINMENU_STD_WIDTH), _ctrlGrpHeight - _radioCtrlsY - (2 * DPSO_ADMINMENU_STD_HEIGHT)];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    if !(_networkCtrls isEqualTo []) then {
        ...
        if (cbChecked _ctrlNetworkCheck) then {
            ...
            if (_idx < 0) exitWith {
                systemChat "[DPSO Admin Menu] No network selected";
            };
