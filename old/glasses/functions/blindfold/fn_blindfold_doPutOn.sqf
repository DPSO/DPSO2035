 ...
 *	\z\dpso\addons\glasses\functions\blindfold\fn_blindfold_doPutOn.sqf
 *	by Ojemineh
 *
 *	put blindfold on
 *
 ...
 *
 *	Example:
 *	[_player, _target] call DPSO_glasses_fnc_blindfold_doPutOn;
 *
 */
...
[_caller, _target] spawn {
	...
	private _blindfolds = ["DPSO_Blindfold_Black", "DPSO_Blindfold_White", "DPSO_Blindfold_White_Blood"];
	...
	if (_googles != "") then {
		...
		[_target, _googles, 1, [1,2,3], true] call DPSO_fnc_addItem;
	};
